...
public class EntityAIFollowOwnerCrow extends EntityAIBase
{
    ...
    public EntityAIFollowOwnerCrow(EntityTameable par1EntityTameable, double par2, float par4, float par5)
    {
