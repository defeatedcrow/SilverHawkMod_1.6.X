...
public class EntitySilverChicken extends EntityTameable{
	...
	public EntitySilverChicken(World par1World)
	{
		super (par1World);
	...
	public EntitySilverChicken spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntitySilverChicken entity = new EntitySilverChicken(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntitySilverChicken))
        {
            return false;
        }
        else
        {
            EntitySilverChicken entity = (EntitySilverChicken)par1EntityAnimal;
