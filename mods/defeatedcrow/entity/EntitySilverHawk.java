...
public class EntitySilverHawk extends EntityTameable implements IEntityFlighter{
	...
	public EntitySilverHawk spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntitySilverHawk entity = new EntitySilverHawk(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntitySilverHawk))
        {
            return false;
        }
        else
        {
            EntitySilverHawk entity = (EntitySilverHawk)par1EntityAnimal;
