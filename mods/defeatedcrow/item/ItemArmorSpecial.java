...
public class ItemArmorSpecial extends ItemArmor implements ISpecialArmor{
	
	public static ArmorProperties spArmorProp;
	private int playerX;
	private static final String[] armorPartSP = new String[] {"helmet","suits","leggins","hawkboots"};
	
				
	public ItemArmorSpecial(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
	...
	{
		this.itemIcon = par1IconRegister.registerIcon("crowsdefeat:" + armorPartSP[this.armorType]);
	}
	...
	public String getArmorTexture(ItemStack itemstack, Entity entity, int slot, int layer) {
		...
		if(armorId == SilverHawkCore.armHKBoots.itemID)
		{
