...
public class BiomeGenBaseReverse extends BiomeGenBase{
	...
	//バイオームの登録
	public static BiomeGenBaseReverse[] reverseBiomeList = new BiomeGenBaseReverse[10];
    ...
    public static final BiomeGenBaseReverse reverseMountainEdge = (BiomeGenBaseReverse) (new BiomeGenReverseMountainEdge(5, SilverHawkCore.biomeIdRMountainEdge))
            .setColor(7501978).setBiomeName("ReverseMountainEdge").setTemperatureRainfall(0.6F, 0.4F).setMinMaxHeight(0.2F, 0.9F);
    /**Double biomes
	 * サブバイオーム。地面と天井が有る。*/
    public static final BiomeGenBaseReverse doublePlains = (BiomeGenBaseReverse) (new BiomeGenDoublePlain(6, SilverHawkCore.biomeIdDplain))
            .setColor(9286496).setBiomeName("DoublePlains").setTemperatureRainfall(0.8F, 0.4F);
    /**Curious biomes
	 * サブバイオーム。浮島が豊富な変則的天地。実際は高めに作った山に穴を開けて作る。*/
    public static final BiomeGenBaseReverse curiousMountains = (BiomeGenBaseReverse) (new BiomeGenCuriousMountain(7, SilverHawkCore.biomeIdDmountain))
    ...
    public static final BiomeGenBaseReverse curiousInferno= (BiomeGenBaseReverse) (new BiomeGenCuriousInferno(8, SilverHawkCore.biomeIdDLava))
            .setColor(16711680).setBiomeName("CuriousInferno").setTemperatureRainfall(2.0F, 0.0F).setMinMaxHeight(-0.3F, 2.5F);
    public static final BiomeGenBaseReverse reverseMine = (BiomeGenBaseReverse) (new BiomeGenReverseMine(9, SilverHawkCore.biomeIdRmine))
            .setColor(13786898).setBiomeName("ReverseMine").setTemperatureRainfall(1.4F, 0.0F).setMinMaxHeight(0.0F, 0.8F);
	...
	public BiomeGenBaseReverse(int par1, int par2) {
        ...
        reverseBiomeList[par1] = this;
	}
	
	//バイオームを登録する
	public static boolean registerBiome()
	{
		if (SilverHawkCore.biomeIdShifter > 0)
		{
			GameRegistry.addBiome(reversePlains);
			GameRegistry.addBiome(reverseForest);
			GameRegistry.addBiome(reverseOcean);
			GameRegistry.addBiome(reverseMountains);
			GameRegistry.addBiome(reverseBeach);
			GameRegistry.addBiome(reverseMountainEdge);
			GameRegistry.addBiome(doublePlains);
			GameRegistry.addBiome(curiousMountains);
			GameRegistry.addBiome(curiousInferno);
			GameRegistry.addBiome(reverseMine);
			return true;
		}
		return false;
	}
