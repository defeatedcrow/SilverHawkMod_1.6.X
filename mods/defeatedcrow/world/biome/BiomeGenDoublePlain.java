...
public class BiomeGenDoublePlain extends BiomeGenBaseReverse implements CustomBiome{
	
	private WorldGenerator reverseWorldGenerator;
	private BiomeDecoratorReverse reverseBiomeDeco;

	public BiomeGenDoublePlain(int par1, int par2) {
		super(par1, par2);
