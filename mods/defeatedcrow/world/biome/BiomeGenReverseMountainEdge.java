...
public class BiomeGenReverseMountainEdge extends BiomeGenBaseReverse implements CustomBiome{
	
	private WorldGenerator reverseWorldGenerator;
	private BiomeDecoratorReverse reverseBiomeDeco;

	public BiomeGenReverseMountainEdge(int par1, int par2) {
		super(par1, par2);
	...
	public CustomBiomeType thisType() {
		return CustomBiomeType.REVERSE;
	}
