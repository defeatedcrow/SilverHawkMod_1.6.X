...
public class GenLayerAddIslandsReverse extends GenLayerReverse
{
    public GenLayerAddIslandsReverse(long par1, GenLayerReverse par3GenLayer)
    {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        SHLogger.debugInfo("check3 : " + aint1.length);
        return aint1;
    }
}
