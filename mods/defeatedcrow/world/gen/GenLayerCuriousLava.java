...
public class GenLayerCuriousLava extends GenLayerReverse{
	
	public GenLayerCuriousLava(long par1, GenLayerReverse par3GenLayer)
    {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int i2 = 0; i2 < par4; ++i2)
        {
            for (int j2 = 0; j2 < par3; ++j2)
            {
                ...
                if (k3 == 0 && k2 == 0 && l2 == 0 && i3 == 0 && j3 == 0 && this.nextInt(30) == 0)
                {
                    aint1[j2 + i2 * par3] = BiomeGenBaseReverse.curiousInferno.biomeID;
                }
                else
                {
                    aint1[j2 + i2 * par3] = k3;
