...
public class GenLayerZoomReverse extends GenLayerReverse{
	
	public GenLayerZoomReverse(long par1, GenLayerReverse par3GenLayer)
    {
        super(par1);
     ...
     */
    public static GenLayerReverse magnify(long par0, GenLayerReverse par2GenLayer, int par3)
    {
        Object object = par2GenLayer;

        for (int k = 0; k < par3; ++k)
        {
            object = new GenLayerZoomReverse(par0 + (long)k, (GenLayerReverse)object);
        }

        return (GenLayerReverse)object;
    }
